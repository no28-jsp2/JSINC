				...
				<div class="row mt">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form action="updateD" class="form-horizontal style-form" method="post">
								<input type="hidden" name="bno" value="${dep.bno }">
								<div class="form-group">
									<label  class="control-label col-lg-2" style="text-align: center;">제목</label>
									<div class="col-lg-10">
										<input type="text" class="form-control " value="${dep.title }" name="title" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-xs-11">
										<input type="text" class="form-control" name="department" value="${dep.department }" readonly="readonly">
									</div>
									<label class="col-sm-2 col-sm-2 control-label" style="text-align: center;">작성자</label>
									<div class="col-md-3 col-xs-11">
										<input type="text" class="form-control" name="writer" value="${dep.writer }" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-10">
										<textarea class="form-control " name="content" required style="height: 200px;">${dep.content }</textarea>
									</div>
								</div>
								<div class="form-group">
