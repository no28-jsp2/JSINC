		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<!-- 캘린더 -->
					<li><a class="active" href="toDoList"> <i class="fa fa-th"></i><span>스케줄</span>
					</a></li>
							...
							<form action="edit" class="form-horizontal style-form">
								...
								<div class="form-group">
									<label for="ctitle" class="control-label col-lg-2"
										style="text-align: center;">to do</label>
									<div class="col-lg-10">
										<input type="text" class="form-control"
											value="${editPage.todo }" id="ctitle" name="todo" required>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="text-align: center;">날짜</label>
									<div class="col-md-3 col-xs-11">
										<div data-date-viewmode="years" data-date-format="yyyy-mm-dd"
											data-date="${editPage.eDate }"
											class="input-append date dpYears">
											<input type="text" readonly="" value="${editPage.eDate }"
												size="16" class="form-control" name="eDate"> <span
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										...
										<button class="btn btn-theme04" type="button"
											onclick="location.href='toDoList'">취소</button>
									</div>
								</div>
							</form>
						</div>
