...
<!-- by성택_새로운 비밀번호와 비밀번호 확인 값 일치 여부_20200528 추가 -->
<script type="text/javascript">
      function pwChk() {
         ...
         if (pw1 == pw2) {
            ...
            button.disabled = false;	// 두 비밀번호가 일치할 때 '변경'버튼 활성화
         } else {
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								<div class="content-panel pn">
									<div id="profile-02">
										<div class="user">
											<img
												src="${pageContext.request.contextPath }/resources/img/${user.img}"
												class="img-circle" width="80">
											<h4>${user.name }</h4>
										</div>
									</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form action="changePw" method="post"
												onsubmit="return nowChk();">
												<div class="modal-body">
													<input type="password" placeholder="현재 비밀번호" id="usingPW"
														class="form-control" name="nowPW">
												</div>
												<div class="modal-body">
													<input type="password" placeholder="새 비밀번호" id="newPW"
														class="form-control" name="newPW">
												</div>
												<div class="modal-body">
													<input type="password" placeholder="새 비밀번호 확인" id="newChk"
														class="form-control" name="newChk" onchange="pwChk()"><br>
												...
												<div class="modal-footer">
													...
													<button type="submit" class="btn btn-primary"
														disabled="disabled" id="change">변경</button>
												</div>
											</form>
											<!-- by성택_submit 하기전 현재 비밀번호 체크_20200528 -->
											<script type="text/javascript">
		                                       function nowChk(){
											...
											<div class="col-lg-8 col-lg-offset-2 detailed">
												...
												<form role="form" class="form-horizontal">
													<div class="form-group">
														<label class="col-lg-2 control-label">회사</label> <label
															class="col-lg-2 control-label">JS.Inc</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">직급</label> <label
															class="col-lg-2 control-label">${user.dep }</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">부서</label> <label
															class="col-lg-2 control-label">${user.rank }</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">사번</label> <label
															class="col-lg-2 control-label">${user.empNo }</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">이메일</label> <label
															class="col-lg-2 control-label">${user.userEmail }</label>
													</div>
												</form>
											</div>
												...
												<form role="form" class="form-horizontal"
													...
													<div class="form-group">
														<label for="inputEmailReceiveYn"
															class="col-lg-2 control-label">이메일 수신여부</label>
														<div class="col-lg-10">
															<label class="radio-inline"> <input type="radio"
																id="emailReceiveYn" name="mailChk" value="Y" checked>
																동의합니다.
															</label> <label class="radio-inline"> <input type="radio"
																id="emailReceiveYn" name="mailChk" value="N">
																동의하지 않습니다.
															</label>
														</div>
													</div>
