				...
				<div class="row mt">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form action="updateRp" class="form-horizontal style-form" method="post">
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										...
										<input type="text" class="form-control "  name="title" value="${rp.title }" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-xs-11">
										<input type="text" class="form-control" name="department" value="${rp.department }" readonly="readonly">
									</div>
									<label class="col-sm-2 col-sm-2 control-label" style="text-align: center;">작성자</label>
									<div class="col-md-3 col-xs-11">
										<input type="text" class="form-control" name="writer" value="${rp.writer}" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-10">
										<textarea class="form-control " name="content" required style="height: 200px;">${rp.content }</textarea>
									</div>
								</div>
								<div class="form-group">
