...
<jsp:include page="../default/header.jsp" />
            ...
            <section class="panel">
              ...
              <div class="panel-body ">
                <div class="mail-header row">
                  <div class="col-md-8">
                    <h4 class="pull-left"><b>제목:</b> ${rp.title } </h4>
                  </div>
                ...
                <div class="mail-sender">
                  <div class="row">
                    <div class="col-md-4" style="width: 100%;">
                      <span>
                      	<b>보고 대상자 : </b> ${rp.target }&nbsp;&nbsp;
                      	<b>작성자 : </b> ${rp.writer }&nbsp;&nbsp;
                      	<b>부서 : </b> ${rp.department }
                      	</span>
                      	<br>
                      <fmt:formatDate value="${rp.regdate }" pattern="yyyy-MM-dd (E) HH:mm:ss (a)"/> 
                ...
                <div class="compose-btn pull-left">
                  	<a href="report" class="btn btn-sm btn-theme"><i class="fa fa-reply"></i> 목록으로</a>
  ...
  <c:set var="viewName" value="${rp.writer }"></c:set>
<script>
<% 
...
%>
				...
				$("#delete").on('click',function() {
					<% if(chk.equals(viewName)){%>
						location.href = "deleteRp?bno=${rp.bno}";
					<%}else{%>
