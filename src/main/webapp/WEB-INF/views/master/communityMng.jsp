		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<!-- 커뮤니티 관리 -->
					<li><a class="active" href="communityMng"> <i
							class="fa fa-asterisk"></i> <span>커뮤니티 승인/삭제</span>
					</a></li>
												...
												<c:when test="${dto.autho eq 'N' }">
													<td align="center">
														<button type="button" class="btn btn-round btn-success"
															onclick="location.href='permissionCom?title=${dto.title}'">
															<i class="fa fa-check"></i> 승인
														</button>
														<button type="button" class="btn btn-round btn-warning"
															onclick="location.href='deleteCom?title=${dto.title}'">
