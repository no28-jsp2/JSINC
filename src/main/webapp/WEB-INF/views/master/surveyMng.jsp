		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<!-- 사원 관리 -->
					<li class="mt"><a href="memberMng"> <i
					...
					<!-- 설문 관리 -->
					<li><a class="active" href="serveyMng"> <i
							class="fa fa-asterisk"></i> <span>설문 승인/삭제</span>
					</a></li>
				</ul>
				<!-- sidebar menu end-->
			</div>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 설문 승인 관리
				</h3>
				<div class="row mb">
					<!-- page start-->
									...
									<c:forEach items="${list }" var="dto">
										...
										<tr>
											...
											<c:choose>
												<c:when test="${dto.autho eq 'N' }">
													<td align="center">
														<button type="button" class="btn btn-round btn-success"
															onclick="location.href='permissionSur?title=${dto.title}'">
															<i class="fa fa-check"></i> 승인
														</button>
														<button type="button" class="btn btn-round btn-warning"
															onclick="location.href='deleteSur?title=${dto.title}'">
												...
												<c:otherwise>
													<td align="center">
														<button type="button" class="btn btn-round btn-theme04"
															onclick="location.href='deleteSur?title=${dto.title}'">
