						...
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" method="get"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input class="form-control round-form" id="disabledInput"
											type="text" placeholder="${member.empNo }" disabled>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control round-form"
											name="email" value="${member.userEmail }">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">전화번호</label>
									<div class="col-sm-10">
										<input type="text" class="form-control round-form" name="pn"
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="submit" value="수정"
											class="btn btn-round btn-success"> <input
											type="button" value="취소" class="btn btn-round btn-danger"
											onclick="location.href='memberMng'">
									</div>
								</div>
							</form>
						</div>
