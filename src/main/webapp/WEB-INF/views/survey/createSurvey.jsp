					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form action="surveyInput" class="form-horizontal style-form"
								onsubmit="return permission()">

								<div class="form-group">
									<label for="ctitle" class="control-label col-lg-2"
										style="text-align: center;">설문 제목</label>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="text-align: center;">마감 날짜</label>
									<div class="col-md-3 col-xs-11">
										<div data-date-viewmode="years" data-date-format="yyyy-mm-dd"
											data-date="2020-${loginMonth }-${loginDay}"
											class="input-append date dpYears">
											<input type="text" readonly=""
												value="2020-${loginMonth }-${loginDay}" size="16"
												class="form-control" name="eDate"> <span
								...
								<div class="form-group ">
									...
									<div class="col-lg-10">
										...
										&#187; 옵션 갯수 설정에 따른 각 옵션별 항목을 설문 내용 마지막에 적어주세요.<br> ex) 2개
										선택시 : 1. 찬성 // 2. 반대
									</div>
								</div>
								<div class="form-group ">
									<label class="control-label col-lg-2"
										style="text-align: center;">답변 옵션 설정</label>
									<div class="col-lg-10">
										<div class="radio">
											<label> <input type="radio" name="optionsRadios"
												id="optionsRadios1" value="2" checked> 옵션 2개 (1, 2)
											</label>
										</div>
										<div class="radio">
											<label> <input type="radio" name="optionsRadios"
												id="optionsRadios2" value="5"> 옵션 5개 (1, 2, 3, 4, 5)
											</label>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										...
										<button class="btn btn-theme04" type="button"
											onclick="location.href='createSurvey'">초기화</button>
									</div>
								</div>
							</form>
						</div>
