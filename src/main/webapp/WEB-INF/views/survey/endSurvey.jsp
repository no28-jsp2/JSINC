	...
	<section id="container">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="javascript:;">
						...
						<ul class="sub">
							...
							<li class="active"><a href="endSurvey">마감된 설문</a></li>
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 마감된 설문
				</h3>
				<div class="row mb">
					<!-- page start-->
					<div class="content-panel">
						<div class="adv-table">
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									<c:forEach items="${endList }" var="dto_sur">
										<tr class="gradeU">
											<td>${dto_sur.state }</td>
			...
			function() {
				...
				*/
				...
				var oTable = $('#hidden-table-info').dataTable({
					"aoColumnDefs" : [ {"bSortable" : false, "aTargets" : [ 0 ]} ], "aaSorting" : [ [ 3, 'asc' ] ]	// 마감 날짜순
				});
