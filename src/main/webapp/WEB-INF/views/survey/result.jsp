				...
				<div class="row mt">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form action="surveyResult?title=${survey.text }"
								class="form-horizontal style-form">
								<div class="form-group ">
									<label for="ccomment" class="control-label col-lg-2"
										style="text-align: center;">설문 내용</label>
									<div class="col-lg-10">
										<p>${survey.text }</p>
									</div>
								</div>
										...
										<c:choose>
											<c:when test="${opt == 2 }">
												1. <b style="color: blue;">${answer1 }</b> 명&nbsp;(<fmt:formatNumber
													value="${(answer1 / total)}" type="percent" />)
												<div class="progress progress-striped">

													<div class="progress-bar progress-bar-success"
														role="progressbar" aria-valuemax="100"
														style="width: ${(answer1 / total)*100}%"></div>
												</div>
												2. <b style="color: blue;">${answer2 }</b> 명&nbsp;(<fmt:formatNumber
													value="${(answer2 / total)}" type="percent" />)
												<div class="progress progress-striped">
													<div class="progress-bar progress-bar-info"
														role="progressbar" aria-valuemax="100"
														style="width: ${(answer2 / total)*100}%"></div>
												</div>
											</c:when>
											<c:otherwise>
												1. <b style="color: blue;">${answer1 }</b> 명&nbsp;(<fmt:formatNumber
												...
												3. <b style="color: blue;">${answer3 }</b> 명&nbsp;(<fmt:formatNumber
													value="${(answer3 / total)}" type="percent" />)
												<div class="progress progress-striped">
													<div class="progress-bar progress-bar-warning"
														role="progressbar" aria-valuemax="100"
														style="width: ${(answer3 / total)*100}%"></div>
												</div>
												4. <b style="color: blue;">${answer4 }</b> 명&nbsp;(<fmt:formatNumber
													value="${(answer4 / total)}" type="percent" />)
												<div class="progress progress-striped">
													<div class="progress-bar progress-bar-danger"
														role="progressbar" aria-valuemax="100"
														style="width: ${(answer4 / total)*100}%"></div>
												</div>
												5. <b style="color: blue;">${answer5 }</b> 명&nbsp;(<fmt:formatNumber
													value="${(answer5 / total)}" type="percent" />)
												<div class="progress progress-striped">
													<div class="progress-bar progress-bar-five"
														role="progressbar" aria-valuemax="100"
														style="width: ${(answer5 / total)*100}%"></div>
												</div>
											</c:otherwise>
										</c:choose>
